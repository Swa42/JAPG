...
class Flames:
    ...
    def __init__(self):
        self.flames = pygame.image.load('fireball_image.png')
...
class Mario:
    ...
    def __init__(self):
        self.mario_img = pygame.image.load('maryo_look.png')
...
def game_over():
    ...
    music = pygame.mixer.Sound('mario_ends.wav')
    music.play()
...
def start_game():
    canvas.fill(BLACK)
    start_img = pygame.image.load('starter.png')
